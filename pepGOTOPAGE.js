...
browserStartPromise.then(function (browserObj){
   ...
   console.log("GooglePagrOpen");
    ...
    console.log("wait for element to be visibale");
     ...
     let waitForElement=page.waitForSelector("#lp_modal_close",{visible:true});
     return waitForElement;

}).then(function (){
    console.log("ClickForCut");
    
     let ClickForCut=page.click("#lp_modal_close",{delay:100});
     return ClickForCut;
    ...
    console.log("ElementWillBeClick");
     ...
     let ElementWillBeClick=allelem[6].click({delay:100});
